...
import { Plus, Minus, Trash2, ShoppingCart, Receipt, Package, ShoppingBag } from "lucide-react";
    ...
    <>
      ...
      <div className="lg:hidden fixed bottom-4 right-4 z-30">
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 bg-[#4A776E] text-white rounded-full shadow-lg shadow-slate-300"
        >
